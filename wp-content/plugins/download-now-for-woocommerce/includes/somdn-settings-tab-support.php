			...
			<div class="somdn-col-12 somdn-guide somdn-guide-features">
				...
				<ul>
					<li>
						...
						<p>If you want to include only specific products rather than affecting all that meet the requirements, on the <a href="<?php echo somdn_get_plugin_link_full(); ?>&tab=settings">settings</a> page you can choose <em>Include selected products only</em>. With this setting turned on, only products you choose will be available without checkout. Go to the product page and in the <strong>Download Now</strong> box on the right, tick the box to include that product.</p>
					...
					<li>
						...
						<p><strong>Download Now</strong> was built with WooCommerce memberships in mind. There are various options to choose from if you have the official Memberships plugin installed. By default if a product is free but requires the user have a specific membership plan, that product will only be available to download for free by those users.</p>
					...
					<li>
						...
						<p>The download count can also be reset on a per-product basis.</p>
	...
	<div class="somdn-container">
		<div class="somdn-row">
			...
			<div class="somdn-col-8 somdn-guide">
				...
				<p><strong>Download Now</strong> includes some extra shortcodes to use with free downloads.</p>
...
<div class="somdn-pre-wrap">

<pre class="somdn-settings-pre"><code>array(
	'id' => '',
	'align' => 'left',
	'text' => ''
)</code></pre>
				...
				<div class="somdn-pre-wrap">
					<pre class="somdn-settings-pre"><code>[download_now id="99" text="Get it Free!"]</code></pre>
				</div>
...
<pre class="somdn-settings-pre"><code>array(
	...
	'text' => ''
				...
				<p><strong>Example</strong></p>
				<div class="somdn-pre-wrap">
					<pre class="somdn-settings-pre"><code>[download_now_page id="99" text="Get it Free!"]</code></pre>
				</div>
				...
				<ul>
					<li>
				<div class="somdn-pre-wrap">
					<pre class="somdn-settings-pre"><code>[add_to_cart id=""]</code></pre>
				</div>
					<p>This WooCommerce shortcode doesn't work well with a free download if you allow downloading from shop/archive pages in this plugin's settings. Use the above <em>Free Download</em> shortcode instead.</p>
					</li>
				</ul>
...
add_action('somdn_support_explained_after_memberships', 'somdn_support_explained_after_multiple_test');

function somdn_support_explained_after_multiple_test() {
	?>
		<li><a href="#sdfsdsd">Wtf?</a></li>
	<?php
}
		...
		<div class="somdn-row">
			...
			<div class="somdn-col-8 somdn-guide">
				...
				<ol>
					...
					<li><a href="#docs">PDF Viewer</a></li>
					<?php do_action( 'somdn_support_explained_after_docs_list' ); ?>
				</ol>

			</div>

			<div class="somdn-col-8 somdn-guide" style="padding-top: 0;">
	...
	<div class="somdn-container">
		<div class="somdn-row">
			...
			<div class="somdn-col-12 somdn-guide">
				...
				<h2>More Support</h2>
				<p><?php echo somdn_get_forum_link(); ?></p>
