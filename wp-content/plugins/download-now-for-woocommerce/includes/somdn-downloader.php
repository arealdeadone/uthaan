...
function somdn_is_download_valid( $product_id, $email = '' ) {
...
function somdn_duplicate_pdf( $email = '', $file, $product_id ) {
...
function somdn_woo_download( $email = '', $file_path, $product_id, $force = false ) {
...
function somdn_download_single() {
	...
	somdn_is_download_valid( $product_id, $email );
	...
	if ( $pdf ) {
		somdn_show_pdf( $email, $file_path, $product_id );
	} else {
		somdn_woo_download( $email, $file_path, $product_id );
	}
...
function somdn_download_multi_checked() {
	...
	if ( $downloadall ) {
		somdn_download_all_files( $email, $product_id );////////////////////////////////////////////////////////////////////////////
		return;
	}
...
function somdn_download_all_files( $product_id = '', $email = '' ) {
...
function somdn_zip_all_download_files( $downloads, $title ) {
	...
	$fileurl = $upload_dir['baseurl'] . '/download-now-uploads/' . $title . '-' . $downloadID . '.zip';
