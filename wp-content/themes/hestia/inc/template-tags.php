...
if ( ! function_exists( 'hestia_comments_template' ) ) :
	...
	function hestia_comments_template() {
		...
		$args = array(
			...
			'must_log_in' => '<p class="must-log-in">' . sprintf( __( 'You must be <a href="%s">logged in</a> to post a comment.', 'hestia-pro' ), wp_login_url( apply_filters( 'the_permalink', get_permalink() ) ) ) . '</p> </div>',
